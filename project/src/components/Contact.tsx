...
export default function Contact() {
  return (
    <div className="pt-24 pb-16 bg-gradient-to-r from-gray-100 to-gray-200">
            ...
            <div className="space-y-6">
              <div className="flex items-start space-x-4">
                ...
                <div>
                  ...
                  <p className="mt-1 text-gray-600">160 Robinson Road #1404, Singapore 068197</p>
                </div>
              </div>
              ...
              <div className="flex items-start space-x-4">
                ...
                <div>
                  ...
                  <a href="mailto:contact@kninnovate.com" className="mt-1 text-blue-600 hover:text-blue-800">
                    Info@kninnovate.com
                  </a>
                </div>
              </div>
